  ...
  private async sendEmailNotification(contact: Contact) {
    try {
      await this.resend.emails.send({
        ...
        html: `
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f4f6f8; padding: 0px 0;">
      <tr>
        <td align="center">
          <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; font-family: Arial, Helvetica, sans-serif;">
            ...
            <tr>
              <td style="padding: 32px;">
                ...
                <div style="background-color: #f0f4f9; padding: 12px 16px; border-left: 4px solid #006eebff; color: #333; border-radius: 4px;">
                  ${contact.message}
                </div>
  ...
  `,
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f4f6f8; padding: 0px 0;">
      <tr>
        <td align="center">
          <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; font-family: Arial, Helvetica, sans-serif;">
            <tr style="background-color: #0077ffff">
              <td style=" text-align: center;">
                <img src="https://globalsc.ao/logo-email.png" alt="Global Services Corporation" style=" width: 100%; object-fit: contain" />
              </td>
            </tr>
            <tr>
              <td style="padding: 32px;">
                <p style="color: #333; font-size: 15px;">Olá, Sr.(a) <strong>${contact.name}</strong>,</p>
                ...
                <p style="margin-top: 32px; color: #333; font-size: 15px;">
                  ...
                  <a href="https://globalsc.ao" style="color: #0077ffff; text-decoration: none;">www.globalsc.ao</a>
                </p>
                <hr style="border: none; border-top: 1px solid #ddd; margin: 32px 0;" />
